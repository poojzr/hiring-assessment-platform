    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-navy-800">Candidate Report</h1>
        </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
              ...
              <p className="text-2xl font-bold text-navy-800">{sessions.length}</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
              ...
              <p className="text-2xl font-bold text-red-600">{report.violation_summary?.total || 0}</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
              <p className="text-sm text-gray-500">Shortlisted</p>
              <p className="text-2xl font-bold text-blue-600">{candidate.shortlisted ? 'Yes' : 'No'}</p>
            </div>
          </div>
      ...
      {activeTab === 'sessions' && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
          <h3 className="font-semibold text-navy-800 mb-4">Sessions History</h3>
          {sessions.length === 0 ? (
