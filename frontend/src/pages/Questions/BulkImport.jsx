...
export default function BulkImport() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <h1 className="text-2xl font-bold text-navy-800 mb-6">Bulk Import Questions</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
            ...
            <input
              ...
              id="file-upload"
            />
            <label htmlFor="file-upload" className="inline-block px-4 py-2 bg-accent-500 hover:bg-accent-600 text-white rounded-md font-medium transition-colors cursor-pointer">
              Choose File
            </label>
          </div>
        ...
        {errors.length > 0 && (
          <div className="mt-6 pt-6 border-t border-gray-200">
            <h3 className="font-medium text-red-600 mb-3">Import Errors</h3>
        ...
        {results && (
          <div className="mt-6 pt-6 border-t border-gray-200">
            <h3 className="font-medium text-navy-800 mb-3">Import Results</h3>
            ...
            {results.results && results.results.length > 0 && (
              <div className="mt-4 max-h-48 overflow-y-auto">
                {results.results.map((r, index) => (
                  <div key={index} className={`text-sm p-1 ${r.status === 'success' ? 'text-green-600' : 'text-red-600'}`}>
