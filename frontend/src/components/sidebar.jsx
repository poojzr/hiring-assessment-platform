...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          w-64 bg-navy-800 text-white flex flex-col flex-shrink-0
      ...
      >
        <div className="p-4 border-b border-navy-700 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="lg:hidden p-1 rounded hover:bg-navy-700 min-h-[36px] min-w-[36px] flex items-center justify-center"
